...
-- Fallback strings used by t() when a translation key is missing from the
-- loaded .po file. Built once at require time instead of per miss.
local fallbacks = {
    ...
    menu_desc_length_settings = "Description Length",
